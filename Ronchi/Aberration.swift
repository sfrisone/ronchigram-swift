...
//  Ronchi
//
//  Created by LeBeau Group iMac on 9/15/17.
...
public class Aberratio:NSObject {
    ...
    var aberrDict:NSMutableDictionary = [:]
        // key is C_01, C_10, etc/A_0, B_2, etc (String)
    ...
    public init(_ nVal:Int, _ mVal:Int, _ CnmaVal:Float, _ CnmbVal:Float) {
